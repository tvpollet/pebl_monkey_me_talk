...
Some of these are different at _p_ = .001 (but likely does not survive correction). This implies the strength of the edges between the nodes could vary between species. 
