...
* When coding this textbooks - Example species chosen.

--

* Example: For example, Buss (2019: 502) writes: _‘other primates besides humans, such as chimpanzees, baboons, and macaques, also engage in reciprocal helping (de Waal, 1982). Taken together, this evidence suggests a long evolutionary history of altruism.’._
...
* Most algorithms force unique cluster membership, and also force that each node is part of a cluster.
...
Some of these are different at _p_ = .001 but does not survive correction. This implies the strength of the edges between the nodes could vary between species. 
